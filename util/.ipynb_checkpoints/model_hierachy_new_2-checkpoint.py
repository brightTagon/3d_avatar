...
class model_gs_deg_time_view_hierachy_new_triplane_h_pos_lowres_lowtime_triplane_level(torch.nn.Module):
    ...
    def forward(self, sample_coord, t, deg, c2f_level):  #t, deg):
        ...
        sampled_positions = sample_combine_8.squeeze().T #sampled_positions_perlatent #sample_combine_32 #+sample_combine_16+sample_combine_32+sampled_positions_perlatent
